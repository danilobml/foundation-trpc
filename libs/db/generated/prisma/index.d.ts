...
export namespace Prisma {
  ...
  */
  ...
  > = {
    ...
    meta: {
      modelProps: 'user' | 'admin' | 'credentials'
      ...
      Credentials: {
        ...
        operations: {
          ...
          count: {
            ...
            result:
              | $Utils.Optional<CredentialsCountAggregateOutputType>
              | number
          }
        }
      }
  ...
  export type UserOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    'uid' | 'createdAt' | 'updatedAt' | 'name' | 'image' | 'AuthProvider',
    ExtArgs['result']['user']
  >
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    Credentials<T extends User$CredentialsArgs<ExtArgs> = {}>(
      args?: Subset<T, User$CredentialsArgs<ExtArgs>>,
    ): Prisma__CredentialsClient<
      $Result.GetResult<
  ...
  export type AdminOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<'uid', ExtArgs['result']['admin']>
  ...
  > = {
     ...
     */
    orderBy?:
      | CredentialsOrderByWithRelationInput
      | CredentialsOrderByWithRelationInput[]
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     *
  ...
  > = {
    where?: CredentialsWhereInput
    orderBy?:
      | CredentialsOrderByWithAggregationInput
      | CredentialsOrderByWithAggregationInput[]
    ...
    Prisma.PrismaPromise<
      Array<
        PickEnumerable<CredentialsGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof CredentialsGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  type CredentialsGetPayload<
    S extends boolean | null | undefined | CredentialsDefaultArgs,
  > = $Result.GetResult<Prisma.$CredentialsPayload, S>

  type CredentialsCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = Omit<
  ...
  > {
    ...
    updateManyAndReturn<T extends CredentialsUpdateManyAndReturnArgs>(
      args: SelectSubset<T, CredentialsUpdateManyAndReturnArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$CredentialsPayload<ExtArgs>,
        T,
    ...
    aggregate<T extends CredentialsAggregateArgs>(
      args: Subset<T, CredentialsAggregateArgs>,
    ...
    >(
      args: SubsetIntersection<T, CredentialsGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
  ...
  > = {
     ...
     */
    data: XOR<
      CredentialsUpdateManyMutationInput,
      CredentialsUncheckedUpdateManyInput
    >
    /**
  ...
  export type UserWhereInput = {
    ...
    AuthProvider?:
      | EnumAuthProviderNullableFilter<'User'>
      | $Enums.AuthProvider
      | null
    Credentials?: XOR<
      CredentialsNullableScalarRelationFilter,
      CredentialsWhereInput
    > | null
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    AuthProvider?:
      | EnumAuthProviderNullableWithAggregatesFilter<'User'>
      | $Enums.AuthProvider
      | null
  }
  ...
  export type CredentialsScalarWhereWithAggregatesInput = {
    AND?:
      | CredentialsScalarWhereWithAggregatesInput
      | CredentialsScalarWhereWithAggregatesInput[]
  ...
  export type UserUpdateInput = {
    ...
    AuthProvider?:
      | NullableEnumAuthProviderFieldUpdateOperationsInput
      | $Enums.AuthProvider
      | null
  ...
  export type EnumAuthProviderNullableFilter<$PrismaModel = never> = {
    ...
    notIn?:
      ...
      | null
    not?:
      | NestedEnumAuthProviderNullableFilter<$PrismaModel>
      | $Enums.AuthProvider
      | null
  }
  ...
  export type EnumAuthProviderNullableWithAggregatesFilter<
    $PrismaModel = never,
  > = {
    equals?:
      | $Enums.AuthProvider
    ...
    notIn?:
      ...
      | null
    not?:
      | NestedEnumAuthProviderNullableWithAggregatesFilter<$PrismaModel>
      | $Enums.AuthProvider
      | null
    _count?: NestedIntNullableFilter<$PrismaModel>
  ...
  export type CredentialsCreateNestedOneWithoutUserInput = {
    create?: XOR<
      ...
      CredentialsUncheckedCreateWithoutUserInput
    >
  ...
  export type CredentialsUpdateOneWithoutUserNestedInput = {
    ...
    update?: XOR<
      XOR<
        CredentialsUpdateToOneWithWhereWithoutUserInput,
        CredentialsUpdateWithoutUserInput
      >,
      CredentialsUncheckedUpdateWithoutUserInput
    >
  }
  ...
  export type UserCreateNestedOneWithoutCredentialsInput = {
    create?: XOR<
      ...
      UserUncheckedCreateWithoutCredentialsInput
    >
  ...
  export type UserUpdateOneRequiredWithoutCredentialsNestedInput = {
    ...
    update?: XOR<
      XOR<
        UserUpdateToOneWithWhereWithoutCredentialsInput,
        UserUpdateWithoutCredentialsInput
      >,
      UserUncheckedUpdateWithoutCredentialsInput
    >
  }
  ...
  export type NestedEnumAuthProviderNullableWithAggregatesFilter<
    $PrismaModel = never,
  > = {
    equals?:
      | $Enums.AuthProvider
